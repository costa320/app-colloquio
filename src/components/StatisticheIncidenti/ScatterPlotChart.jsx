...
/* MIDDLEWARES */
/* EXTRAS */
import { adeguateData } from "./dataAdeguator.js";
...
export default class ScatterPlotChart extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    nextProps.accidents &&
      this.setState({ accidents: nextProps.accidents }, () => {
        adeguateData(this.state.accidents)
          .then(formatted_accidents => {
            self.setSTATE("formattedAccidents", formatted_accidents);
            document.getElementById("ScatterPlotChart").innerHTML = "";
  ...
  renderChart(data) {
    ...
    chart
      .point()
      .position("GIORNO*ORARIO")
      .color("GRAVITA")
      .size(4)
      .opacity(0.65)
      .shape("GRAVITA", ["circle", "square", "triangle"])
      .tooltip("GRAVITA*DataOraIncidente*NUM_MORTI*NUM_FERITI*NUM_ILLESI");
    chart.render();
  }
  ...
  render() {
    ...
    return (
      <Fragment>
        <div id="ScatterPlotChart" className="maxH"></div>
      </Fragment>
    );
  }
